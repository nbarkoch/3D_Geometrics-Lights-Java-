...
public class SpotLight extends PointLight {
    ...
    /**
     * Spot light constructor gets 6 parameters
     *
     ...
     * @param radius    is the radius of the spot light resulting a circled light
     */
    public SpotLight(Color intensity, Point3D position, Vector direction, double kA, double kB, double kC, double radius) {
        super(intensity, position, kA, kB, kC, radius);
        _direction = direction.normalized();
    }

    /**
     * Spot light constructor gets 5 parameters
     *
     * @param intensity intensity of light source
     * @param position  the location of the PointLight
     * @param direction the direction of the highest intensity of spotLight
    ...
    public SpotLight(Color intensity, Point3D position, Vector direction, double kA, double kB, double kC) {
        this(intensity, position, direction, kA, kB, kC, 0);
    }
