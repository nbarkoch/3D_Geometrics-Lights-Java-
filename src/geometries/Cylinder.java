...
public class Cylinder extends Tube {
    ...
    public Cylinder(Color emission, double height, Ray ray, double radius) {
        this( emission, new Material(0, 0,0), height,ray,radius);
    }
    ...
    public Cylinder(double height, Ray ray, double radius) {
        this(Color.BLACK, new Material(0, 0,0), height,ray,radius);
    }
    ...
    /**
     * Cylinder intersection points - could be 0/1/2 points
     *
    ...
    public List<GeoPoint> findIntersections(Ray ray) {
        ...
        List<GeoPoint> intersectionPlaneA = planeA.findIntersections(ray);
        List<GeoPoint> intersectionPlaneB = planeB.findIntersections(ray);
