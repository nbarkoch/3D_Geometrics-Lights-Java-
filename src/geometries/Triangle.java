...
public class Triangle extends Polygon {
    ...
    public Triangle(Color emission, Point3D vertex, Point3D vertex1, Point3D vertex2) {
        this(emission, Material.DEFAULT, vertex, vertex1, vertex2);
    }
    ...
    public Triangle(Point3D vertex, Point3D vertex1, Point3D vertex2) {
        this(Color.BLACK, Material.DEFAULT, vertex, vertex1, vertex2);
    }
    ...
    public List<GeoPoint> findIntersections(Ray ray, double maxDistance) {
        ...
        if (intersections == null) return null;
            intersections.get(0).geometry = this; // it's a triangle, it's more correct than call it polygon
