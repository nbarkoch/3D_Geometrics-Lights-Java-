...
public class Tube extends RadialGeometry {
    ...
    public Tube(Color emission, Ray axisRay, double radius) {
        this(emission, new Material(0,0,0), axisRay, radius);
    }
    ...
    /**
     * Tube intersection points - could be 0/1/2 points
     *
    ...
    public List<GeoPoint> findIntersections(Ray ray) {
        ...
        return t1 > 0 && t2 > 0 ? List.of(new GeoPoint(this, ray.get_target_point(t1)), new GeoPoint(this, ray.get_target_point(t2))) :
                t1 <= 0 && t2 <= 0 ? null :
                        t1 <= 0 ? List.of(new GeoPoint(this, ray.get_target_point(t2))) :
                                List.of(new GeoPoint(this, ray.get_target_point(t1)));
    }
}
