...
public class ReflectionRefractionTests {
    ...
    public void threeGeometries_1() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, -460, -480), new Vector(0, 0.65, 1), new Vector(0, -1, 0.65)));
        ...
        scene.addGeometries( //
                new Triangle(Color.BLACK, new Material(0.2, 0.35, 30, 0, 0.2), //
                        new Point3D(-150, 60, 100), new Point3D(150, 60, 100), new Point3D(75, 45, 280)), //
                new Triangle(Color.BLACK, new Material(0.2, 0.35, 30, 0, 0.2), //
                        new Point3D(-150, 60, 100), new Point3D(-75, 45, 280), new Point3D(75, 45, 280)), //

                new Polygon(Color.BLACK, new Material(0.1, 0.35, 30, 0, 0.2), //
                        new Point3D(-75, 45, 280), new Point3D(-75, -145, 280), new Point3D(75, -145, 280), //
                        new Point3D(75, 45, 280)), //

                new Polygon(Color.BLACK, new Material(0.1, 0.35, 30, 0, 0.2), //
                        new Point3D(150, 60, 100), new Point3D(75, 45, 280), new Point3D(75, -145, 280), //
                        new Point3D(150, -145, 100)), //
                new Polygon(Color.BLACK, new Material(0.1, 0.35, 30, 0, 0.2), //
                        new Point3D(-150, 60, 100), new Point3D(-75, 45, 280), new Point3D(-75, -145, 280), //
                        new Point3D(-150, -145, 100)), //
                new Sphere(new Color(java.awt.Color.BLUE), new Material(0.2, 0.3, 40, 0, 0.1), // )
                        30, new Point3D(30, 22, 150)),
                new Cylinder(new Color(java.awt.Color.GREEN), new Material(0.2, 0.3, 50, 0, 0.1),
                        75, new Ray(new Point3D(-25, 50, 170), new Vector(0, -1, 0)), 25),
                new Triangle(new Color(java.awt.Color.RED), new Material(0.3, 0.2, 50, 0.7, 0), //
                        new Point3D(-25, 57, 125), new Point3D(30, 55, 130), new Point3D(0, -30, 70)),
                new Triangle(new Color(java.awt.Color.RED), new Material(0.3, 0.2, 50, 0.7, 0), //
                        new Point3D(-25, 57, 125), new Point3D(22, 57, 110), new Point3D(0, -30, 70)),
                new Triangle(new Color(java.awt.Color.RED), new Material(0.3, 0.2, 50, 0.7, 0), //
                        new Point3D(30, 55, 130), new Point3D(22, 57, 110), new Point3D(0, -30, 70)),
                new Triangle(new Color(java.awt.Color.RED), new Material(0.3, 0.2, 50, 0.7, 0), //
                        new Point3D(30, 55, 130), new Point3D(22, 57, 110), new Point3D(-25, 57, 125)));
