...
public class CameraIntegrationTest {
    ...
    public void CameraSphereIntersections() {
        ...
        Sphere sphere4 = new Sphere(4d, new Point3D(0, 0, 4 / 3d));
    ...
    public void CameraPlaneIntersections() {
        ...
        Plane plane1 = new Plane(new Point3D(0, 0, 3), camera2.getVTo());
        ...
        Plane plane2 = new Plane(new Point3D(0, 0, 2), new Vector(0, -1, -2));
        ...
        Plane plane3 = new Plane(new Point3D(0, 0, 3), new Vector(0, -2, -2));
        ...
        Plane plane4 = new Plane(new Point3D(0, 0, 3), camera2.getVUp());
