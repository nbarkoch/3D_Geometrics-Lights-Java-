...
class TriangleTest {
    ...
    void findIntersections() {
        ...
        assertEquals( List.of(new Point3D(3, 0, 1.625)),
                triangle.findIntersections(new Ray(new Point3D(3, 1.5, 2), new Vector(0, -2, -0.5))),"Ray's line should be in triangle at different point");
        ...
        assertNull(triangle1.findIntersections(new Ray(new Point3D(3, 1, 2), new Vector(0, -2, 0))), "Ray's line shouldn't be in triangle");
        // TC12: Intersect in vertex
        assertNull(triangle1.findIntersections(new Ray(new Point3D(3, 2, 4), new Vector(0, -2, 0))), "Ray's line shouldn't be in triangle");
        // TC13: Intersect on edge's continuation
        assertNull(triangle1.findIntersections(new Ray(new Point3D(-1, 2, -2), new Vector(0, -2, 0))), "Ray's line shouldn't be in triangle");
    }
}