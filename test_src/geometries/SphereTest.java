...
class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        result = sphere.findIntersections(new Ray(new Point3D(2, 0, 0),
                new Vector(2, 1, 0)));
        assertNull(result, "Ray do not cross sphere");
        ...
        result = sphere.findIntersections(new Ray(new Point3D(1, 1, 0),
                new Vector(0, -1, 0)));
        assertEquals( 1, result.size(),"Wrong number of points");
        assertEquals( List.of(p5), result,"Ray crosses sphere only one place");
        ...
        assertEquals( 1, result.size(),"Wrong number of points");
        assertEquals( List.of(p7), result,"Ray crosses sphere only one place");

        // TC17: Ray starts at sphere and goes outside (0 points)
        result = sphere.findIntersections(new Ray(new Point3D(1, -1, 0),
                new Vector(0, -1, 0)));
        assertNull(result, "Ray doesn't cross sphere");
        ...
        result = sphere.findIntersections(new Ray(new Point3D(0.75, 1, 0),
                new Vector(1, 0, 0)));
        assertNull(result, "Ray doesn't cross through sphere");
